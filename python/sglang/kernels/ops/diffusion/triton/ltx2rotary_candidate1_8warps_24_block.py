# B1: BLOCK_HEADS=24 only, original num_warps logic
# block_heads = 24
# num_warps = min(8, max(1, 24)) = 8
# grid = (32, 1) = 32 blocks
...
def apply_ltx2_split_rotary_emb(
    ...
    block_heads = num_heads  # B1: Changed from min(16, next_power_of_2(num_heads))
    num_warps = min(8, max(1, block_heads))  # B1: original num_warps logic
