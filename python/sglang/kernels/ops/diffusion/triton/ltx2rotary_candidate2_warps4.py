# B3: Full R06 - BLOCK_HEADS=24 + num_warps=4
# block_heads = 24
# num_warps = 4
# grid = (32, 1) = 32 blocks
...
def apply_ltx2_split_rotary_emb(
    ...
    block_heads = num_heads  # B3: Changed from min(16, next_power_of_2(num_heads))
    num_warps = 4  # B3: Changed from min(8, max(1, block_heads))
